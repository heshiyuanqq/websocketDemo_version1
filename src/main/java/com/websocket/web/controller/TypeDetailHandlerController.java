...
public class TypeDetailHandlerController implements WebSocketHandler {
	...
	private static final Logger logger= Logger.getLogger(TypeDetailHandlerController.class);
