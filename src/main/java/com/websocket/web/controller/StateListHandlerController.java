...
public class StateListHandlerController implements WebSocketHandler {
	...
	private static final Logger logger= Logger.getLogger(StateListHandlerController.class);
