...
/**
 * 供我本地浏览器接入的(以获取C#端session的最新状态)
 * @author Administrator
 *
 */

public class StateDetailHandlerController implements WebSocketHandler {
	...
	private static final Logger logger= Logger.getLogger(StateDetailHandlerController.class);
